...
<div class="page-fixed-main-content">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-globe" aria-hidden="true"></i>المدن</div>
            <div class="tools"> </div>
        </div>
        <div class="portlet-body ">
            <a href="{{ Route('cities.create')}}" class="btn blue">إضافة</a>
            <br>
            <br>
            ...
            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td  class='noter' data-title="المدينة">{{$c->name }}

                        </td>
                        <td  class='noter' data-title="المنطقة">{{$c->area->name }}
                        ...
                        <td data-title="خيارات">
                            ...
                            @if($c->orders==null)
                            <a href="#"	value="{{route("cities.destroy",$c)}}"
